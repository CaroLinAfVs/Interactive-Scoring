...
function Home({ setSelectedValue }: HomeProps) {
  return (
    <div className="bg-gradient-black w-[400px] rounded-xl p-[30px] flex flex-col">
      ...
      <h2 className="mt-7 mb-4 text-text-color text-3xl font-bold">How did we do?</h2>
      ...
      <div className="flex my-7 text-text-color">
        {[1, 2, 3, 4, 5].map((num) => (
          <button
            key={num}
            className="focus:bg-button-active hover:bg-button-bgk rounded-full mx-2 w-12 h-12 bg-small-button-bkg"
